...
namespace KingTides.Wp8.Pan.Behavior
{
    /// <summary>
    ///     Provides a rounded rectangular clipping that scales with the element.
    /// </summary>
    /// <remarks>
    /// from http://expressionblend.codeplex.com/SourceControl/changeset/view/61176#494852
    /// </remarks>
    public class ClippingBehavior : Behavior<FrameworkElement>
    {
        ...
        protected virtual void UpdateClipping()
        {
            ...
            var bounds = new Rect(Margin.Left, Margin.Top, width, height);
